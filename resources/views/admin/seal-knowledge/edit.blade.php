                    ...
                    <div class="col-12 mb-4">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('title') is-invalid @enderror" 
                                   id="title" name="title" 
                                   value="{{ old('title', $sealKnowledge->title) }}" required>
                            @error('title')
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control @error('sort') is-invalid @enderror" 
                                                   id="sort" name="sort" 
                                                   value="{{ old('sort', $sealKnowledge->sort) }}">
                                            @error('sort')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="form-check form-switch">
                                                <input type="checkbox" class="form-check-input" 
                                                       ...
                                                       {{ old('status', $sealKnowledge->status) ? 'checked' : '' }}>
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control" id="meta_description" 
                                                      ...
                                                      rows="3">{{ old('meta_description', $sealKnowledge->meta_description) }}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="mb-3">
