                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.settings.update', $setting->id) }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control bg-light border-0" id="key"
                                    value="{{ $setting->key }}" readonly style="cursor: not-allowed">
                            ...
                            <div class="d-grid gap-2">
                                ...
                                <a href="{{ route('admin.settings.index') }}" class="btn btn-outline-secondary">返回列表</a>
                            </div>
                        </form>
                    </div>
                </div>
