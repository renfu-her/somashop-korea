        ...
        <div class="container px-0">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav main-menu mr-auto">
                    <li class="nav-item dropdown no-arrow">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="aboutUsDropdown">
                            ...
                            <li class="nav-item">
                                <a class="nav-link " href="brand.php?p=32">品牌故事</a>
                            </li>
                        ...
                        <ul class="dropdown-menu sub-menu" aria-labelledby="navbarDropdown">
                            ...
                            <li class="nav-item dropdown no-arrow">
                                <a class="nav-link dropdown-toggle active" href="#" id="navbarDropdown"
                                    ...
                                    新手媽咪首選區 <i class="fas fa-angle-down"></i>
                                </a>
                                <ul class="dropdown-menu sub-sub-menu" aria-labelledby="navbarDropdown">

                                    <li class="nav-item">
                                        <a class="nav-link" href="product_list.php?c=28">隨身外出盒</a>
                                    </li>

                                    <li class="nav-item">
                                        <a class="nav-link" href="product_list.php?c=47">專屬客製專區</a>
                                    </li>
                            ...
                            <li class="nav-item dropdown no-arrow">
                                <a class="nav-link dropdown-toggle active" href="#" id="navbarDropdown"
                                    role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    胎毛肚臍章、開運章 <i class="fas fa-angle-down"></i>
                                </a>
                                <ul class="dropdown-menu sub-sub-menu" aria-labelledby="navbarDropdown">

                                    <li class="nav-item">
                                        <a class="nav-link" href="product_list.php?c=14">南非赤牛角</a>
                                    </li>

                                    <li class="nav-item">
                                        <a class="nav-link" href="product_list.php?c=24">上等檀木系列</a>
                                    </li>

                                    <li class="nav-item">
                                        <a class="nav-link" href="product_list.php?c=34">尊爵版、奢華版印鑑組</a>
                                    </li>

                                    <li class="nav-item">
                                        <a class="nav-link" href="product_list.php?c=25">生肖琥珀、葫蘆波麗章</a>
                                    </li>

                                    <li class="nav-item">
                                        <a class="nav-link" href="product_list.php?c=26">透明波麗 臍帶胎毛章</a>
                                    </li>

                                    <li class="nav-item">
                                        <a class="nav-link" href="product_list.php?c=23">水晶奇緣系列</a>
                                    </li>

                                    <li class="nav-item">
                                        <a class="nav-link" href="product_list.php?c=27">粉玉髓</a>
                                    </li>
                            ...
                            <li class="nav-item dropdown no-arrow">
                                <a class="nav-link dropdown-toggle active" href="#" id="navbarDropdown"
                                    ...
                                    aria-expanded="false">
                                    結婚對章 <i class="fas fa-angle-down"></i>
                                </a>
                                <ul class="dropdown-menu sub-sub-menu" aria-labelledby="navbarDropdown">

                                    <li class="nav-item">
                                        <a class="nav-link" href="product_list.php?c=32">上等檀木</a>
                                    </li>
                            ...
                            <li class="nav-item dropdown no-arrow">
                                <a class="nav-link dropdown-toggle active" href="#" id="navbarDropdown"
                                    role="button" data-toggle="dropdown" aria-haspopup="true"
                                    aria-expanded="false">
                                    公司章 <i class="fas fa-angle-down"></i>
                                </a>
                                <ul class="dropdown-menu sub-sub-menu" aria-labelledby="navbarDropdown">

                                    <li class="nav-item">
                                        <a class="nav-link" href="product_list.php?c=29">上等檀木</a>
                                    </li>
                            ...
                            <li class="nav-item dropdown no-arrow">
                                <a class="nav-link dropdown-toggle active" href="#" id="navbarDropdown"
                                    role="button" data-toggle="dropdown" aria-haspopup="true"
                                    aria-expanded="false">
                                    胎毛手鍊、項鍊 <i class="fas fa-angle-down"></i>
                                </a>
                                <ul class="dropdown-menu sub-sub-menu" aria-labelledby="navbarDropdown">

                                    <li class="nav-item">
                                        <a class="nav-link" href="product_list.php?c=39">胎毛手鍊</a>
                                    </li>

                                    <li class="nav-item">
                                        <a class="nav-link" href="product_list.php?c=40">胎毛項鍊</a>
                                    </li>
                            ...
                            <li class="nav-item dropdown no-arrow">
                                <a class="nav-link dropdown-toggle active" href="#" id="navbarDropdown"
                                    role="button" data-toggle="dropdown" aria-haspopup="true"
                                    aria-expanded="false">
                                    胎毛筆 <i class="fas fa-angle-down"></i>
                                </a>
                                <ul class="dropdown-menu sub-sub-menu" aria-labelledby="navbarDropdown">

                                    <li class="nav-item">
                                        <a class="nav-link" href="product_list.php?c=41">紅壇胎毛筆</a>
                                    </li>
                            ...
                            <li class="nav-item dropdown no-arrow">
                                <a class="nav-link dropdown-toggle active" href="#" id="navbarDropdown"
                                    role="button" data-toggle="dropdown" aria-haspopup="true"
                                    aria-expanded="false">
                                    商品周邊加購區 <i class="fas fa-angle-down"></i>
                                </a>
                                <ul class="dropdown-menu sub-sub-menu" aria-labelledby="navbarDropdown">

                                    <li class="nav-item">
                                        <a class="nav-link" href="product_list.php?c=36">金足印</a>
                                    </li>
                            ...
                            <li class="nav-item dropdown no-arrow">
                                <a class="nav-link dropdown-toggle active" href="#" id="navbarDropdown"
                                    role="button" data-toggle="dropdown" aria-haspopup="true"
                                    aria-expanded="false">
                                    胎毛梳 <i class="fas fa-angle-down"></i>
                                </a>
                                <ul class="dropdown-menu sub-sub-menu" aria-labelledby="navbarDropdown">

                                    <li class="nav-item">
                                        <a class="nav-link" href="product_list.php?c=43">綠檀木梳子</a>
                                    </li>
                    ...
                    <li class="nav-item dropdown no-arrow">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="faqDropdown">
                            ...
                            <li class="nav-item">
                                <a class="nav-link " href="faq.php?c=7">會員購物相關聲明</a>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link " href="faq.php?c=4">產品相關疑問</a>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link " href="faq.php?c=6">購物與製作流程</a>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link " href="faq.php?c=5">關於印章</a>
                            </li>
                        </ul>
                    </li>
                ...
                <form class="form-inline my-2 my-lg-0" action="search.php" method="get">
                    <div class="input-group">
                        <input type="text" class="form-control input-search input-border-radius-50 bg-search"
                            placeholder="搜尋" aria-label="Search" aria-describedby="basic-addon2" name="search"
                            value="">
            ...
            <ul class="navbar-nav navbar-navright flex-row ml-md-auto ml-0 pr-md-3 pr-2">
                <li class="nav-item mx-md-3 mx-2">
                    <a class="nav-link btn-widget" href="proc.php?proc=logout">
