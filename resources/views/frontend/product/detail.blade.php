                            ...
                            <div class="product-info">
                                ...
                                <div class="product-price mt-4">
                                    <p class="mb-2 original-price">정가：<span
                                            id="original-price">{{ number_format($product->price) }}</span> 원</p>
                                    <h3 class="text-danger">할인가：<span
                                            id="cash-price">{{ number_format($product->spec_price) }}</span> 원</h3>
                                </div>
        ...
        $(document).ready(function() {
            ...
            $('#spec-select').change(function() {
                ...
                if (selectedOption.val()) {
                    ...
                    $('#cash-price').text('{{ number_format($product->spec_price) }} 원');
                }
            });
