(function($) {
    ...
    var tour = new Tour({
        ...
        template: "<div class='popover tour'><div class='arrow'></div><h3 class='popover-title'></h3><div class='popover-content'></div><div class='p-2'><button class='btn btn-secondary btn-sm me-1' data-role='prev'>Prev</button><button class='btn btn-secondary btn-sm me-3' data-role='next'>Next</button><button class='btn btn-danger btn-sm' data-role='end'>End tour</button></div></div>",
        autoscroll: 'true',
        backdrop: 'true',
